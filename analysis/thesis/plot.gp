...
plot "baseline.csv" using "skew":"median" title "baseline" with linespoint,\
		 "hot1_1M.csv" using "skew":"median" title "hotkey subset: 2 keys" with linespoint,\
		 "hot10_1M.csv" using "skew":"median" title "hotkey subset: 10 keys" with linespoint,\
		 "hot100_1M.csv" using "skew":"median" title "hotkey subset: 100 keys" with linespoint,\
		 "hot1K_1M.csv" using "skew":"median" title "hotkey subset: 1000 keys" with linespoint
