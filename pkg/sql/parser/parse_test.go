...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`PREPARE a (INT8) AS UPSERTHOT INTO a VALUES ($1)`},
		{`PREPARE a AS UPSERTHOT INTO a VALUES (1)`},
		{`PREPARE a (INT8) AS UPSERTHOT INTO a VALUES ($1)`},
		...
		{`UPSERTHOT INTO a VALUES (1)`},
		{`EXPLAIN UPSERTHOT INTO a VALUES (1)`},
		{`UPSERTHOT INTO a.b VALUES (1)`},
		{`UPSERTHOT INTO a VALUES (1, 2)`},
		{`UPSERTHOT INTO a VALUES (1, DEFAULT)`},
		{`UPSERTHOT INTO a VALUES (1, 2), (3, 4)`},
		{`UPSERTHOT INTO a VALUES (a + 1, 2 * 3)`},
		{`UPSERTHOT INTO a(a, b) VALUES (1, 2)`},
		{`UPSERTHOT INTO a SELECT b, c FROM d`},
		{`UPSERTHOT INTO a DEFAULT VALUES`},
		{`UPSERTHOT INTO a DEFAULT VALUES RETURNING a, b`},
		{`UPSERTHOT INTO a DEFAULT VALUES RETURNING 1, 2`},
		{`UPSERTHOT INTO a DEFAULT VALUES RETURNING a + b`},
		{`UPSERTHOT INTO a DEFAULT VALUES RETURNING NOTHING`},
...
func TestUnimplementedSyntax(t *testing.T) {
	testData := []struct {
		...
		{`UPSERTHOT INTO foo(a, a.b) VALUES (1,2)`, 27792, ``},
